...
public class AsyncCocktailListFromCategory extends AsyncTask<String, Void, JSONObject> {

    private AppCompatActivity mainAct;

    public AsyncCocktailListFromCategory(AppCompatActivity mainAct){
        ...
        try {
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    //Sending the correct cocktail to the cocktailActivity through the cocktail ID
